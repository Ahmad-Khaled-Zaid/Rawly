...
public class UserUpdateDTO {
    @ValidFirstName(isUpdate = true, groups = UpdateGroup.class)
    @Nullable
    private String firstName;

    @ValidLastName(isUpdate = true, groups = UpdateGroup.class)
    @Nullable
    private String lastName;

    @ValidUsername(isUpdate = true, groups = UpdateGroup.class)
    @Nullable
    private String username;

    @ValidEmail(isUpdate = true, groups = UpdateGroup.class)
    @Nullable
    private String email;

    @ValidPhoneNumber(isUpdate = true, groups = UpdateGroup.class)
    @Nullable
